...
또한 k8s를 이용하여 인프라 자체를 구성하기보다는 pod를 동적으로 할당하여 auto scaling을 해보려고 한다.

검색 엔진의 경우에는 컴파일된 파일 자체를 gitlab에 올려두고... 이것도 ci/cd화하는 것을 도전해보려고 한다. auto scaling은 주로 이것이 대상이 될 것이다. 
