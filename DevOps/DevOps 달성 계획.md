...
***협업도구***는 wiki.js 와 mattermost를 사용할 것이다. 이것을 gitlab과 연동하여 이슈 관리를 해보려고 한다.
"초기에는 GitLab과 Mattermost 연동을 통해 알림 체계를 구성하고, 추후 Incident 대응 체계까지 확장할 예정이다." 이것으로 ***알림 항목***을 달성할 수 있다.
